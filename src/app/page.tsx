  ...
  return (
    <div className='bg-black'>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEDFB6]">
        <h1 className="text-6xl font-bold mb-6 text-[#401606]">Undian Gathering SBU HMPM 2025</h1>
        ...
        <div className="flex gap-2 mt-3">
          ...
          >
            <img src="/250k.png" alt="Cash 200K" className="w-20 h-20" />
            E WALLET 1
          </button>
          <button
            className={`px-6 py-3 text-lg text-white rounded-lg transition-colors bg-[#008109] hover:bg-[#429F00] font-bold flex flex-col justify-center items-center`}
          ...
          >
            <img src="/200k.png" alt="Cash 200K" className="w-20 h-20" />
            E WALLET 2
          </button>
          <button
            className={`px-6 py-3 text-lg text-white rounded-lg transition-colors bg-[#008109] hover:bg-[#429F00] font-bold flex flex-col justify-center items-center`}
          ...
          >
            <img src="/100k.png" alt="Cash 200K" className="w-20 h-20" />
            E WALLET 3
          </button>
        </div>
        <div className='mt-16'>
