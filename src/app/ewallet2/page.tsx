...
export default function Home() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setCounter(
        localStorage.getItem("ewallet2")
          ? parseInt(localStorage.getItem("ewallet2")!)
          : 100
      );
      setParticipants(
  ...
  const startRandomizer = () => {
    ...
    localStorage.setItem("ewallet2", (tunaiCounter - 1).toString());
  };
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#FAEFD9]">
        <h1 className="text-3xl font-bold mb-6 text-[#401606]">
          Undian 10 E-Wallet 200 Ribu Rupiah
        </h1>
        <div className="mb-6 relative">
          <img src="/200K.png" alt="200K" className="w-48 h-48" />
        </div>
        {!isAnimating ? (
